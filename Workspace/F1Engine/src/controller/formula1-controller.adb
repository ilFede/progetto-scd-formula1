...
package body Formula1.Controller is
   ...
   -- inizializza CORBA
	 ...
	 null;
      ...
      procedure Send_Fuel_Level (Pilot_Number : in CORBA.Long; Fuel_Level : in String_Ref_T) is
      begin
	 MDLControlPanel.TimePanelInterface.sendFuelLevel (MyInterface, Pilot_Number, CORBA.To_CORBA_String (Fuel_Level.all));
	 null;
      end;
      --+--------
